            ...
            try {
                const stripeSession =
                    await stripe.checkout.sessions.create({
                        success_url: `${process.env.NEXT_APP_URL}/thankyou?orderId=${order.id}`,
                        cancel_url: `${process.env.NEXT_APP_URL}/wishlists`,
                ...
                return { url: `${process.env.NEXT_APP_URL}/wishlists` }
            }
        }),
